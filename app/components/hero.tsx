    ...
    <div className={classes.hero_section}>
      <div className={classes.hero_content_container}>
        ...
        <p className={classes.hero_content_p}>
          Filaquin<span>&#8482;</span> features NMXFBR4<span>&#8482;</span>, our
          proprietary blend of yeast extract (beta-glucan), apple fiber, yeast
          culture (postbiotic), and psyllium husk fiber. This combination offers
          both insoluble and soluble fibers along with prebiotics and
